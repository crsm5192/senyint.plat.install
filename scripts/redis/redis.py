...
from lib.python.slog import slog
from lib.python.cmds import cmds
from lib.python.filecache import filecache
from lib.python.utils import which

class Redis(object):        
    def __init__(self, logpath,  password="deaN9mizr_ZRzy1", port=6379, debug=False):
    ...
    def get_item(self,  key, port=6379, password=None, force=False):
        ...
        rds_cli_path = "redis-cli"
        rds_paths_def = "/usr/bin/redis-cli"
...
if __name__ == '__main__':
    redis_passwd_file = "/etc/zabbix/scripts/redis/.redis.passwd"
