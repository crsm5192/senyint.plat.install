...
class Mysql(object):
    ...
    def __init__(self, iphost="127.0.0.1", username="connuser", password="dalianzhirong321_A", port=33066, debug=True):
        self._iphost = iphost
    ...
    def _get_mysql_cmd_output(self, hostname="127.0.0.1",username=None,password=None,port=None):
        try:
