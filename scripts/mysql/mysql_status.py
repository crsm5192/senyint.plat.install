...
from lib.QLog import Log

class Mysql(object):
    logpath = "/tmp/zabbix_mysql_status.log"
    
    def __init__(self, hostname="127.0.0.1",iphost="127.0.0.1", username="connuser", password="dalianzhirong321_A", port=33066, debug=True):
    ...
    def get_mysql_cmd_output(self, hostname="127.0.0.1",username="connuser",password="dalianzhirong321_A",port=33066):
        try:
            ...
            if os.path.isfile("/usr/bin/mysqladmin"):
                mysql_path = "mysqladmin"
